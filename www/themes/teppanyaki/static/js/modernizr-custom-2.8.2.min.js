...
window.Modernizr = function(a, b, c) {
    ...
    m = f(G, "undefined") || f(G.call, "undefined") ? function(a, b) {
      ...
      var c;
      return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : D(["@media (", v.join("touch-enabled),("), q, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(a) {
        c = 9 === a.offsetTop
      }), c
      ...
      var a = !!j("perspective");
      return a && "webkitPerspective" in p.style && D("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(b) {
      ...
      var a;
      return D(["#", q, "{font:0/0 a}#", q, ':after{content:"', t, '";visibility:hidden;font:3px/1 a}'].join(""), function(b) {
        a = b.offsetHeight >= 3
      }), a
    }, A.video = function() {
    ...
    for (var H in A) m(A, H) && (l = H.toLowerCase(), Modernizr[l] = A[H](), B.push((Modernizr[l] ? "" : "no-") + l));
    return Modernizr.addTest = function(a, b) {
        if ("object" == typeof a)
          for (var d in a) m(a, d) && Modernizr.addTest(d, a[d]);
        else {
          if (a = a.toLowerCase(), Modernizr[a] !== c) return Modernizr;
          b = "function" == typeof b ? b() : b, "undefined" != typeof o && o && (p.className += " " + (b ? "" : "no-") + a), Modernizr[a] = b
        }
        return Modernizr
      }, d(""), r = k = null,
      function(a, b) {
        ...
        a.html5 = s, i(b)
      }(this, b), Modernizr._version = n, Modernizr._prefixes = v, Modernizr._domPrefixes = y, Modernizr._cssomPrefixes = x, Modernizr.mq = E, Modernizr.hasEvent = F, Modernizr.testProp = function(a) {
        return h([a])
      }, Modernizr.testAllProps = j, Modernizr.testStyles = D, p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (o ? " js " + B.join(" ") : ""), Modernizr
  }(this, this.document),
  function(a, b, c) {
    function d(a) {
